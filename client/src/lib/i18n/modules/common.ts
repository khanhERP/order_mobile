...
export const commonTranslations: { [key: string]: CommonTranslations } = {
  ko: {
    ...
    itemDiscount: "상품 할인",
    orderDiscount: "주문 할인",
    allocatedOrderDiscount: "주문 할인 배분",
  ...
  en: {
    ...
    allocatedOrderDiscount: "Allocated Order Discount",
    items: " items",
    filters: "Filters",
    collapse: "Collapse",
    expand: "Expand",
  ...
  vi: {
    ...
    allocatedOrderDiscount: {
      vi: "Phân bổ giảm giá ĐH",
      ko: "주문 할인 배분",
      en: "Allocated Order Discount",
    },
    totalTax: "Thuế GTGT",
    ...
    subtotal: "Tổng phụ",
    tax: "Thuế",
    itemDiscount: "Giảm giá SP",
    orderDiscount: "Giảm giá ĐH",
    allocatedOrderDiscount: "Phân bổ giảm giá ĐH",
    items: "món",
    category: "Danh mục",
    status: "Trạng thái",
    active: "Đang bán",
