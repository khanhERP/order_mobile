...
export const tablesTranslations: { [key: string]: TablesTranslations } = {
  ko: {
    ...
    confirmCleanup: "청소 완료 확인",
    discountCannotExceedPrice: "할인은 상품 가격을 초과할 수 없습니다",
    deleteItem: "항목 삭제",
    noItems: "항목 없음",
    sendAllToKitchen: "모두 주방으로 보내기",
    confirmCancelOrder: "주문 취소 확인",
    enterCancelReason: "취소 사유를 입력하세요",
    enterCancelReasonPlaceholder: "취소 사유 입력...",
    pleaseEnterCancelReason: "취소 사유를 입력하세요",
    cancelled: "취소됨",
    reason: "사유",
    confirmCancel: "취소 확인",
    decreaseItemQuantity: "항목 수량 감소",
    decreaseQuantityOrSplitWithNote: "수량 감소 또는 메모와 함께 항목 분할",
    itemName: "항목",
    currentQuantity: "현재 수량",
    quantityToDecrease: "감소할 수량",
    enterNoteOptionalPlaceholder: "메모 입력 (선택 사항)...",
    invalidQuantity: "잘못된 수량",
    cannotDecreaseQuantity: "수량을 줄일 수 없습니다",
    confirmDeleteItem: "항목 삭제 확인",
    areYouSureToDeleteItem: "이 항목을 삭제하시겠습니까?",
    itemAlreadySentToKitchen: "항목이 주방으로 전송되었습니다",
    reasonForDeletion: "삭제 사유",
    enterReasonForDeletionPlaceholder: "삭제 사유 입력...",
    itemDeleted: "항목이 삭제되었습니다",
    cannotDeleteItem: "항목을 삭제할 수 없습니다",
    itemSentToKitchenCannotDeleteDirectly: "항목이 주방으로 전송되었습니다. 삭제하려면 사유를 입력하세요",
  ...
  en: {
    ...
    discountCannotExceedPrice: "Discount cannot exceed product price",
    deleteItem: "Delete Item",
    noItems: "No Items",
    sendAllToKitchen: "Send All to Kitchen",
    confirmCancelOrder: "Confirm Cancel Order",
    enterCancelReason: "Please enter cancellation reason",
    enterCancelReasonPlaceholder: "Enter cancellation reason...",
    pleaseEnterCancelReason: "Please enter cancellation reason",
    cancelled: "Cancelled",
    reason: "Reason",
    confirmCancel: "Confirm Cancel",
    decreaseItemQuantity: "Decrease Item Quantity",
    decreaseQuantityOrSplitWithNote: "Decrease quantity or split item with note",
    itemName: "Item",
    currentQuantity: "Current quantity",
    quantityToDecrease: "Quantity to decrease",
    enterNoteOptionalPlaceholder: "Enter note (optional)...",
    invalidQuantity: "Invalid quantity",
    cannotDecreaseQuantity: "Cannot decrease quantity",
    confirmDeleteItem: "Confirm Delete Item",
    areYouSureToDeleteItem: "Are you sure you want to delete this item?",
    itemAlreadySentToKitchen: "Item has been sent to kitchen",
    reasonForDeletion: "Reason for deletion",
    enterReasonForDeletionPlaceholder: "Enter reason for deletion...",
    itemDeleted: "Item deleted",
    cannotDeleteItem: "Cannot delete item",
    itemSentToKitchenCannotDeleteDirectly: "Item has been sent to kitchen, please enter reason to delete",
  ...
  vi: {
    ...
    discountCannotExceedPrice: "Giảm giá không được vượt quá giá sản phẩm",
    deleteItem: "Xóa món",
    noItems: "Không có món",
    sendAllToKitchen: "Gửi bếp",
    confirmCancelOrder: "Xác nhận hủy đơn hàng",
    enterCancelReason: "Vui lòng nhập lý do hủy đơn hàng",
    enterCancelReasonPlaceholder: "Nhập lý do hủy đơn...",
    pleaseEnterCancelReason: "Vui lòng nhập lý do hủy đơn",
    cancelled: "Đã hủy",
    reason: "Lý do",
    confirmCancel: "Xác nhận hủy",
    decreaseItemQuantity: "Giảm số lượng món",
    decreaseQuantityOrSplitWithNote: "Giảm số lượng hoặc tách món với ghi chú",
    itemName: "Món",
    currentQuantity: "Số lượng hiện tại",
    quantityToDecrease: "Số lượng cần giảm",
    enterNoteOptionalPlaceholder: "Nhập ghi chú (tùy chọn)...",
    invalidQuantity: "Số lượng không hợp lệ",
    cannotDecreaseQuantity: "Không thể giảm số lượng",
    confirmDeleteItem: "Xác nhận xóa món",
    areYouSureToDeleteItem: "Bạn có chắc chắn muốn xóa món này?",
    itemAlreadySentToKitchen: "Món đã được gửi vào bếp",
    reasonForDeletion: "Lý do xóa",
    enterReasonForDeletionPlaceholder: "Nhập lý do xóa món...",
    itemDeleted: "Đã xóa món",
    cannotDeleteItem: "Không thể xóa món",
    itemSentToKitchenCannotDeleteDirectly: "Món đã được gửi vào bếp, vui lòng nhập lý do để xóa",
