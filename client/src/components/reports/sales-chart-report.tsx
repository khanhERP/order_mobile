...
export function SalesChartReport() {
  ...
  const {
    ...
    queryKey: [
      "https://order-mobile-be.onrender.com/api/orders/date-range",
      startDate,
      endDate,
      startTime,
      endTime,
    ...
    queryFn: async () => {
      try {
        ...
        const response = await fetch(
          `https://order-mobile-be.onrender.com/api/orders/date-range/${encodeURIComponent(startDateTimeISO)}/${encodeURIComponent(endDateTimeISO)}`,
        );
        if (!response.ok) {
  ...
  const { data: products } = useQuery({
    queryKey: ["https://order-mobile-be.onrender.com/api/products", selectedCategory, productType, productSearch],
    queryFn: async () => {
      const response = await fetch(
        `https://order-mobile-be.onrender.com/api/products/${selectedCategory}/${productType}/${productSearch || ""}`,
      );
  ...
  const { data: customers } = useQuery({
    queryKey: ["https://order-mobile-be.onrender.com/api/customers", customerSearch, customerStatus],
    queryFn: async () => {
      const response = await fetch(
        `https://order-mobile-be.onrender.com/api/customers/${customerSearch || "all"}/${customerStatus}`,
      );
  ...
  const { data: productAnalysisData, isLoading: productAnalysisLoading } =
    useQuery({
      queryKey: [
        "https://order-mobile-be.onrender.com/api/product-analysis",
      ...
      queryFn: async () => {
        ...
        const response = await fetch(`https://order-mobile-be.onrender.com/api/product-analysis?${params}`);
