...
export function CustomerFormModal({ isOpen, onClose, customer }: CustomerFormModalProps) {
  ...
  const generateCustomerId = async () => {
    try {
      const response = await apiRequest("GET", "https://order-mobile-be.onrender.com/api/customers/next-id");
  ...
  const createMutation = useMutation({
    mutationFn: async (data: CustomerFormData) => {
      const response = await apiRequest("POST", "https://order-mobile-be.onrender.com/api/customers", data);
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: CustomerFormData) => {
      const response = await apiRequest("PUT", `https://order-mobile-be.onrender.com/api/customers/${customer!.id}`, data);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["https://order-mobile-be.onrender.com/api/customers"] });
